        ...
        <div style={{ 
            ...
            <Space size="large" style={{ 
                ...
                <Badge count={5} size="small" offset={[2, 2]}>
                    <BellOutlined style={{ cursor: 'pointer', color: COLORS.WHITE }} />
                </Badge>
            ...
            <Space size="middle">
                ...
                <div style={{ 
                    ...
                    <Text style={{ color: COLORS.WHITE, fontSize: '12px', opacity: 0.8 }}>Admin</Text>
                    <Text style={{ color: COLORS.WHITE, fontWeight: 'bold' }}>Manager</Text>
                </div>
                <Button 
                    type="text" 
                    icon={<LogoutOutlined />} 
